...
class OpenAIDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(ChatBotsMetaTableSeeder::class);
        $this->call(ArchivesTableSeeder::class);
        $this->call(ArchivesMetaTableSeeder::class);
        $this->call(EmbededResourcesTableSeeder::class);
        $this->call(EmbededResourcesMetaTableSeeder::class);
