@foreach ($variants as $variant)
    <div class="swiper-slide rounded-lg w-full h-full relative" id="{{ $variant->id }}">
        ...
        <div class="absolute top-3 right-3 z-10 flex gap-2">
            <a href="{{ $variant->imageUrl() }}" download="{{ $variant->title }}" class="file-need-download relative md:w-[34px] md:h-[34px] w-7 h-7 flex items-center m-auto justify-center rounded-lg delete-image-bg border border-color-47">
