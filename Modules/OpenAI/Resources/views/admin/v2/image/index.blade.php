...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="image-v2-list-container">
    <div class="card">
...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\v2\ImageController@pdf', $prms) ? '1' : '0' }}";
    var csv = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\v2\ImageController@csv', $prms) ? '1' : '0' }}";
    var listContaner = "image-v2-list-container";
    var endRoute = "/images/";
</script>
